...
pilot and chef */
const { pilot, chef, jonk , guidance} = spaceship

const pilot = spaceship.pilot
const chef = spaceship.chef
const jonk = spaceship.jonk
const guidance = spaceship.guidance

console.log(pilot) // 'elon musk'
console.log(jonk) // undefined
...
const makeMeAPizza = { topping: "deliciouso 🤠"}
```
