...
- the filter and the sorting of the pigs
- Filter and sorting!
- When to move the state to the App.js rather than the innermost parent
- inverse data flow and properly setting state
